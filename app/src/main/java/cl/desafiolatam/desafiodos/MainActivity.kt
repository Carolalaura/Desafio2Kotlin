...
class MainActivity : AppCompatActivity(), OnItemClickListener {
    ...
    private lateinit var listatareas: MutableList<TaskUIDataHolder>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setUpViews()
        dao = UserRoomDatabase.RoomApplication.getDatabase(application).idDao()
        iniciarLista()
    ...
    //esta funcion transforma desde lista task (base de datos) hasta lista UIDataHolder (vista)
